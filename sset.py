...
def scomplex_to_sset(X):
	return sset(X.vertices, X.facetree)
...
#Z = scomplex([{"x"},{"y"},{"z"},{"x","y"},{"y","z"},{"x","z"},{"x","y","z"},{"y","w"}])
...
#Q1 = Q.simplexcollapse("c")
print(Q.simplices)
print(Q.structuretree)
#for k in [0,1,2,3]:
#print(matrix_rank(Q.boundary_matrix(k)))
